...
var modifyWishList = function (comicId, actionId, failureMessage, callback) {
...
var addToWishList = function (comicId, callback) {
  var actionId = 1;
  var failureMessage = 'Unable to add comic to wish list';
  return modifyWishList(comicId, actionId, failureMessage, callback);
};

var removeFromWishList = function (comicId, callback) {
  var actionId = 0;
  var failureMessage = 'Unable to remove comic from wish list';
  return modifyWishList(comicId, actionId, failureMessage, callback);
};
