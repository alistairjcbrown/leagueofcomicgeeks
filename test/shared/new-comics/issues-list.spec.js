...
module.exports = function (lofcg, newComicsDate) {
  describe('get issues list', function () {
    it('should provide no new comic', function (done) {
      lofcg.newComics.get(undefined, '2017-01-01', function (err, newComics) {
        expect(err).toBeNull();
    ...
    it('should provide a list of new comics', function (done) {
      lofcg.newComics.get(undefined, newComicsDate, function (err, newComics) {
        expect(err).toBeNull();
    ...
    it('should provide a filtered list of new comics', function (done) {
      lofcg.newComics.get(undefined, newComicsDate, { publishers: ['Image Comics'] }, function (err, newComics) {
        expect(err).toBeNull();
    ...
    it('should return an error when provided with an invalid date', function (done) {
      lofcg.newComics.get(undefined, 'foo', function (err) {
