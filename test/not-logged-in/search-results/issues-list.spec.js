...
module.exports = function () {
  describe('get issues list', function () {
    ...
    it('should provide results for known search term', function (done) {
      lofcbg.searchResults.get(undefined, 'Black Magic', function (err, searchResults) {
        expect(err).toBeNull();
    ...
    it('should provide a filtered list of new comics', function (done) {
      lofcbg.searchResults.get(undefined, 'Black Magic', { publishers: ['Image Comics'] }, function (err, searchResults) {
        expect(err).toBeNull();
